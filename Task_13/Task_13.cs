...
//если можно пользоваться троками то все проще. помимо очевидного ели положительное возми 3 а если отрицательное то 4 знак можно как минимум домножать float Correct_number  на (len-Number_str.IndexOf(',')+1) и точно узнать разрядность, отсюда выходить на решение
